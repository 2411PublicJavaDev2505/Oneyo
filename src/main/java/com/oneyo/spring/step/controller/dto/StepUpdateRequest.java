...
public class StepUpdateRequest {
	...
	public String toString() {
		return "StepUpdateRequest [stepNo=" + stepNo + ", stepWriter=" + stepWriter + ", stepContent=" + stepContent
				+ ", stepAmount=" + stepAmount + ", stepFilename=" + stepFilename + ", stepFileRename=" + stepFileRename
