...
public class SourcesUpdateRequest {
	...
	public String toString() {
		return "SourcesUpdateRequest [categoryNo=" + categoryNo + ", sourcesNo=" + sourcesNo + ", sourcesWriter="
				+ sourcesWriter + ", firstCategory=" + firstCategory + ", secondCategory=" + secondCategory
				+ ", thirdCategory=" + thirdCategory + ", sourcesName=" + sourcesName + ", sourcesFilename="
				+ sourcesFilename + ", sourcesFileRename=" + sourcesFileRename + ", sourcesFilepath=" + sourcesFilepath
				+ "]";
	}
